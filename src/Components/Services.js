                ...
                <div className="service-section">
                  ...
                  <div className="service-details">
                    ...
                    <div className="service-text-descr">
                      <p>
                        From websites to apps, we develop everything and make it
                        a perfect fit for your business. Manage your business
              ...
              <Zoom delay={1300}>
                <div className="service-section box-color">
                  ...
                  <div className="service-details">
                    ...
                    <div className="service-text-descr">
                      <p>
                        MDSol Tech empowers every app to engage the audience
                        with your business. Boost the trust of your audience
                        with our intuitive mobile apps, and let them be in touch
                        with you.
                      </p>
                    </div>
                  </div>
              ...
              <Zoom delay={1700}>
                <div className="service-section box-color">
                  ...
                  <div className="service-details">
                    ...
                    <div className="service-text-descr">
                      <p>
                        User experience or user interaction, we care about both.
                        We know how to attract the audience to your website and
                        mobile app. Our lucrative designs begin the engagement
              ...
              <Zoom delay={2100}>
                <div className="service-section box-color">
                  ...
                  <div className="service-details">
                    ...
                    <div className="service-text-descr">
                      <p>
                        Earn a natural rank for your website on the search
                        engine in a short time with our expert SEO services.
                        Along with that, retain the top rank and keep on getting
                        the juice of our SEO strategies.
                      </p>
                    </div>
                  </div>
                </div>
