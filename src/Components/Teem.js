      ...
      <div className="box-wrapper">
        ...
        <div className="text-box">
          <Fade right duration={1500}>
            ...
            <div className="about-section">
              <p>
                A passionate behind a realistic dream can turn the impossible
                into possible. That is what Zeeshan Arshad is, a qualified
                software engineer with a bright idea to serve the business
                digitally.
              </p>
            </div>
          </Fade>
        ...
        <div className="parent-box">
          ...
          <div className="text-box text-box-width">
            <Fade right duration={1500}>
              ...
              <div className="about-section ">
                <p>
                  Inspiration always finds its ways through intuition. Nadeem is
                  a software engineer with the instincts to create robust
                  designs that can maximize the production and revenue for every
                  type of business.
                </p>
              </div>
            </Fade>
        ...
        <div className="text-box order-text-two ">
          <Fade left duration={1500}>
            ...
            <div className="about-section">
              <p>
                Understandability comes first in every project. When a team has
                a software engineer like Sikandar Khan, none of the concepts
                remains in ambiguity. That is why MDSol can please its every
                client.
              </p>
            </div>
          </Fade>
          ...
          <Fade right duration={1500}>
            ...
            <div className="about-section">
              <p>
                ...
                possible with his UI/UX expertise and vast knowledge in this
                line.
              </p>
            </div>
          </Fade>
        ...
        <div className="parent-box">
          ...
          <div className="text-box text-box-width">
            <Fade right duration={1500}>
              ...
              <div className="about-section">
                <p>
                  The golden principle of sales is to understand like a
                  customer. When a person can know what his customer will want
                  and what will satisfy his needs, he is capable of being an IT
                  Sales Executive. Raweewan C. is among those who can empathize
                  with the customers and help them with the best solutions.
                </p>
              </div>
            </Fade>
          </div>
